...
if __name__ == "__main__":
    ...
    median_time_parallel, result_parallel = benchmark(
        mandelbrot_parallel,
        1024, -2, 1, -1.5, 1.5, 100, 4
    )

    visualize_mandelbrot(result_parallel, title="Mandelbrot Set (Parallel)", filename="mandelbrot_parallel.png")